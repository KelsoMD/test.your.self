...
@ComponentScan({"by.nesterenok.testyourself.web.controllers", "by.nesterenok.testyourself.web.aspect"})
public class SpringMvcConfig extends WebMvcConfigurerAdapter {

    @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/assets/**", "mentor/assets/**", "mentor/groups/assets/**",
            "user/groups/assets/**", "user/assets/**", "user/tests/assets/**", "user/tests/build/assets/**",
            "mentor/tests/build/assets/**", "mentor/tests/assets/**", "guest/assets/**", "guest/tests/assets/**",
            "moderator/assets/**", "moderator/questions/assets/**")
